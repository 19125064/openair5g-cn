...
asn_TYPE_member_t asn_MBR_UP_TNLInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UP_TNLInformation, choice.singleTNLInformation),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UP_TNLInformation, choice.multipleTNLInformation),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UP_TNLInformation, choice.choice_Extensions),
