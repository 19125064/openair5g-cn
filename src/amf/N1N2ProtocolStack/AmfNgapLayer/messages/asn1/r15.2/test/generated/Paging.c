...
static int
memb_paging_ies_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_paging_ies_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..65535)) */};
static asn_per_constraints_t asn_PER_type_paging_ies_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (SIZE(0..65535)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_paging_ies_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..65535)) */};
static asn_per_constraints_t asn_PER_memb_paging_ies_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (SIZE(0..65535)) */,
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_paging_ies_2 = {
	...
	{ &asn_OER_type_paging_ies_constr_2, &asn_PER_type_paging_ies_constr_2, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_Paging_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct Paging, paging_ies),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_paging_ies_2,
		0,
		{ &asn_OER_memb_paging_ies_constr_2, &asn_PER_memb_paging_ies_constr_2,  memb_paging_ies_constraint_1 },
		0, 0, /* No default value */
		"paging-ies"
		},
};
